...
private:
    ...
    dme::FTData remove_sensor_inertia(const dme::Cartesian& fct_frame_state, 
...
private:
    ...
    // Rotation matrix of the fct frame with respect to the ft frame
    Eigen::Matrix3d m_rot_fct_ft = Eigen::Matrix3d::Identity(3, 3);

    // Rotation matrix of the fct frame with respect to the fe frame
    Eigen::Matrix3d m_rot_fct_fe;

    // FT offset
    dme::FTData m_ft_offset;
